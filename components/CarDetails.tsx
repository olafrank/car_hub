                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        <div className='flex min-h-full items-center justify-center p-4 text-center'>
                            ...
                            <Transition.Child
                                ...
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-auto transform 
                                rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col p-6">
                                    <button type='button' onClick={closedModal} className='absolute top-2 z-10 w-fit p-2 bg-primary-blue-100
                                    rounded-full'>
